...
const String  forecast[6]        PROGMEM = {"thunderstorm", "rain", "cloudy", "partly cloudy", "clear", "sunny"};
...
void setup()
{
  ...
  lcd.print(F("BMP180 FW"));
  lcd.write(LCD_SPACE_SYMBOL);
  lcd.print(myBMP.readFirmwareVersion());
  delay(2000);
...
void loop()
{
  ...
  value = myBMP.getSeaLevelPressure_hPa(115);                                            //true altitude is 115 meters, do search with google earth or gps
  ...
  /* prints forecast text */
  lcd.setCursor(0, 3);
  lcd.print(forecast[myBMP.getForecast(115)]);
